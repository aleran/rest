...
$DeleteData = "delete from data12 where id='$IdPlato'";
...
$LogSql = "insert into data06(IdOperador, Registro, Módulo, IP, Estado, Tipo)
		   value('$DataU01','Editar plato o categoria','Menú > Editar > Plato o categoría: $Data05','$ipe','¡Exitóso!','0')";
$LogSql = mysql_query($LogSql);
?>
<div class="NotiAvi" title="Notificación">
<center><img src="img/comp.png" width="5%"> ¡Plato editado con éxito!</center><br>
<?php
