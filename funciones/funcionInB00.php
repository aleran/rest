<div id="InResultsSearch" title="Buscar Producto">
<input class="next iNext ui-corner-all" placeholder="Nombre del producto que desea buscar" id="InLData" autocompete="off" onkeypress="return caraftree(event, 'num_car','#LData', 'El producto')" />
<br>
<br>
<div id="RKL"></div>
</div>
...
$("#InLData").keyup(function(){
	datos = $(this).val();
	if (datos.length!=0){
	$.ajax({
		type:"post",
		url:"funciones/funcionInB01.php",
		data:{data:datos},
		beforeSend:function(){
			$("#RKL").html("Buscando...");
		},
...
function caraftree(elEvento, permitidos, idelement, elemento) {
