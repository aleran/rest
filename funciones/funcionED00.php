...
<?php endif ?>
	...
	<label for="password" class="mod-usuario-form title-mod-user">Contraseña</label>
		<input type="password" name="password" id="password" class="text ui-widget-content ui-corner-all mod-usuario-form" style="width:150px;display:inline"/>&nbsp;<button style="display:inline" onclick="resetearp()">Resetear</button>
	</td>
	<?php // if($CodigoTbr!="AA-0000"): ?>
	<?php if($CodigoTbr=="Echo"): ?>
	<td style="padding: 1px 0 8px 1px;">
	...
	<?php endif ?>
	<?php if($CodigoTbr!="AA-0000"): ?>
		<input type="hidden" readonly name="SelectRol" value="<?php echo $ModUserROW['Rol']; ?>" />
