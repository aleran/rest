...
$SQL00 = "select * from data16 where IdOrden='$Data' ";
...
$DataSQL02 = mysql_query($DataSQL02);
	...
	<script type="text/javascript">
		$("#VerOrden").attr("title" , "Número de orden (Borrada): <?php echo $Data;?>");
	</script>
	<span class="UserOrden">
		<b>Quien Ordena: </b> <?php echo $ROW01->CodigoTbr." - ".$ROW01->PrimerNombre." ".$ROW01->PrimerApellido; ?><br>
		<b>Datos </b>[<b>Mesa: </b><?php echo $ROW00->Mesa; ?>] [<b>Fecha: </b><?php echo $fechao; ?>] [<b>Estado:</b> Borrada]
	</span><br>
	<b>Ordenes: </b><br>
