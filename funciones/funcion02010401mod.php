...
if(array_key_exists("orden", $_POST)){
	...
	foreach ($orden as $value) {
		$update_despacho = "UPDATE data14 SET Despacho='1' WHERE Orden='$ROW00->NumeroOrdenActivo'and IdPlato='$value'";
...
if(array_key_exists("ordena", $_POST)){
	$ordena = $_POST["ordena"];
	foreach ($ordena as $value) {
		$update_despacho = "UPDATE data14 SET Despacho='1' WHERE Orden='$ROW00->NumeroOrdenActivo' and IdPerCan='$value'";
		mysql_query($update_despacho);
	}
}
