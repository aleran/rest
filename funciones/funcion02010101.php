...
<div class="Effect">
	...
	<?php
		$Data00 = $_POST["Data"];
		$DataSQL01 = "select * from data12 where sub_id='$Data00' and Nivel='1' and Estado='1' and id_menu='$id_menu_a'";
		$DDataSQL01 = "select * from data12 where sub_id='$Data00' and Nivel='1' and Estado='1' and id_menu='0'";
		...
		while($DDataROW01 = mysql_fetch_array($DDataSQL01)){
			$AddId="";
			$Cate="$DDataROW01[Costo] Bs.";
			if($DDataROW01["Subniveles"]==1){
				$AddId="id='categorias'";
				$Cate="Categoria";
			}
			echo "<li $AddId data01='$DDataROW01[id]' data02='$DDataROW01[Nombre]' data03='$DDataROW01[Subniveles]' data04='$DataROW00[Nombre]'>$DDataROW01[Nombre] ($Cate)</li>";
		}
	?>
	</ul>
</div>
<div id="SubNivel"></div>
<script src="js/funcion02010101.js"></script>
<style>
#SubNivel{
padding:3px;
position:absolute;
